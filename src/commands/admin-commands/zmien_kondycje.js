...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('zmien_kondycje')
		.setDescription('Zmień liczbę punktów kondycji postaci')
        ...
        .addNumberOption(option =>
            option
                .setName('ilosc')
                .setDescription('Liczba punktów kondycji do dodania/odjęcia')
                .setRequired(true)
        )
	,
	...
	async execute(interaction) {
        ...
        character[0].energy += amount;
        character[0].energy = Math.max(0, character[0].energy)
        character[0].energy = Math.min(character[0].energy, character[0].max_energy)

        var message = '```ansi\n[1;32m' + name + '[1;37m ma teraz [1;36m' + character[0].energy + '/' + character[0].max_energy + ' Kondycji[0m\n```'
