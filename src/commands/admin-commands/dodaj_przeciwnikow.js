...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('dodaj_przeciwnikow')
		.setDescription('Dodaj przeciwników do drużyny przed walką')
	...
	async execute(interaction) {
        ...
        for(element of enemy_team[0].members){
            ...
            enemy[0].team = team[0].name;
            team[0].members.push(element);
        }

        var message = '```ansi\n[1;37mDodano przeciwników z drużyny [1;34m' + enemy_team[0].name + '[1;37m do drużyny [1;34m' + team[0].name + '\n\n[1;37mSzykujcie się do walki\n```';
